...
public class RemoteSession {
	...
	private String student_id = "39490830";
	...
	protected void handleLine(String line) {
		...
		line = line.replaceAll(this.student_id, "");
		...
		// If the client side is not using the updated mcpi 
		if ( (this.symmetric_key == null) && (!methodName.equals("dh_key_exchange")) ) {
			System.out.println("Please establish a secure connection before sending commands");
		}
